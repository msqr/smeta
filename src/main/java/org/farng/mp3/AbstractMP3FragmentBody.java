...
extends AbstractMP3FileItem implements MP3MetadataContainer {
     ...
     */
    private List<MP3Object> objectList 
    	= new ArrayList<MP3Object>(AbstractMP3FragmentBody.SIZE_OBJECT_LIST);
    ...
    public Object getObject(final String identifier) {
        ...
        final Iterator iterator = objectList.listIterator();
        while (iterator.hasNext()) {
            final MP3Object abstractMP3Object = (MP3Object) iterator.next();
            final String currentIdentifier = abstractMP3Object.getIdentifier();
            if (currentIdentifier.equals(identifier)) {
