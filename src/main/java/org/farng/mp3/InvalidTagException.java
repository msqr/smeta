 ...
 * <code>TagNotFoundException</code>. Each tag (or MP3 Frame Header) has an
...
public class InvalidTagException extends TagException {
	...
	private static final long serialVersionUID = 7545350101414185613L;
	...
	private void writeObject(final ObjectOutputStream out) {
		throw new UnsupportedOperationException(
				"Cannot write to Output Stream: " + out.toString());
	}
