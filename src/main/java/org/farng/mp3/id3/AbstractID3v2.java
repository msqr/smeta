...
public abstract class AbstractID3v2 extends AbstractID3 {
    ...
    private Map<String, MP3MetadataItem> frameMap = null;
    ...
    protected AbstractID3v2() {
        super();
        frameMap = new LinkedHashMap<String, MP3MetadataItem>();
    }
    ...
    public Iterator getFrameOfType(final String identifier) {
        ...
        final Set<MP3MetadataItem> result = new LinkedHashSet<MP3MetadataItem>(
        		frameMap.size());
        String hashSetKey;
        while (iterator.hasNext()) {
