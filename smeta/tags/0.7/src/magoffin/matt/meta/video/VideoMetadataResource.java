/* ===================================================================
 * VideoMetadataResource.java
 * 
 * Created Jan 29, 2007 10:47:00 AM
 * 
 ...
 */
public interface VideoMetadataResource extends MetadataResource {
	 ...
	 */
	Object getValue(VideoMetadataType type, Locale locale);
	 ...
	 */
	Iterable<?> getValues(VideoMetadataType type, Locale locale);
