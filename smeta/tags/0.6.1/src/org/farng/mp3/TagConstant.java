...
public class TagConstant {
    ...
    static {
		...
		// David Underwood 2/25/2006 
		// add all ID3v2.3 values as key and value to the ID3 2.4 map to avoid 
		// valid tag ID's ID3v2.4 returning null 
	     iterator = id3v2_2ToId3v2_3.values().iterator(); 
	     while (iterator.hasNext())  { 
	    	key = (String)iterator.next();
	    	if ( key != null ) {
	    		id3v2_3ToId3v2_4.put(key, key);
	    	}
	     }
